    ...
    <Layout pageName="Contact Me">
      ...
      <section className={styles.contactSection}>
        <div className={styles.contactContainer}>
          <p>
            If you would like to get in contact with me to discuss web
            development or employment opportunities, feel free to reach out via{" "}
            <a href="https://twitter.com/dyllper">Twitter</a>,{" "}
